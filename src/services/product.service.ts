...
import { CreateProductDTO, InsertProductModel, SelectProductModel } from "@/models/products.model";
import { ProductRepository } from "@/repositories/product.repository";

export class ProductService {
    constructor(private productRepo: ProductRepository){}

    async createProduct(dto: CreateProductDTO): Promise<ApiResponse<SelectProductModel>> {
